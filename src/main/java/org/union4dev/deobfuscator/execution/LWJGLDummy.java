...
public class LWJGLDummy {

    // The window handle
    private long window;

    public static LWJGLDummy instance;
    ...
    public void run() {
        Logger.info("Starting LWJGL Dummy, Version " + Version.getVersion());
    ...
    private void init() {
        ...
        // Create the window
        window = glfwCreateWindow(800, 600, "Loratadine Fucker™", NULL, NULL);
        if (window == NULL) {
